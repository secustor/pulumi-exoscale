...
class SSHKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] public_key: A SSH public key that will be copied into the Compute instances at **first** boot.
        """
        if name is not None:
...
class _SSHKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] fingerprint: The unique identifier of the SSH Key.
        :param pulumi.Input[str] name: The name of the SSH Key.
        :param pulumi.Input[str] public_key: A SSH public key that will be copied into the Compute instances at **first** boot.
        """
