...
class DatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] plan: The plan of the database service (`exo dbaas type show <TYPE>` for reference).
        :param pulumi.Input[str] type: The type of the database service (accepted values: `kafka`, `mysql`, `pg`, `redis`).
        :param pulumi.Input[str] zone: The name of the [zone][zone] to deploy the database service into.
        :param pulumi.Input['DatabaseKafkaArgs'] kafka: *kafka* database service type specific arguments. Structure is documented below.
        :param pulumi.Input[str] maintenance_dow: The day of week to perform the automated database service maintenance (accepted values: `never`, `monday`, `tuesday`, `wednesday`, `thursday`, `friday`, `saturday`, `sunday`).
        :param pulumi.Input[str] maintenance_time: The time of day to perform the automated database service maintenance (format: `HH:MM:SS`)
