...
class NetworkArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] display_text: A free-form text describing the Private Network purpose.
        ...
        :param pulumi.Input[str] netmask: The netmask defining the IP network allowed for the static lease (see `NIC` resource). Required for *managed* Private Networks.
