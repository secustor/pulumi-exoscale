...
namespace Pulumi.Exoscale
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.Exoscale.version.txt");
    ...
    internal sealed class ExoscaleResourceTypeAttribute : Pulumi.ResourceTypeAttribute
    {
